...
class CombinedTeleopUI:
    def __init__(self, node):
        ...
        self.front_camera_status_var = tk.StringVar(value='Waiting for /camera/image_raw')
        self.rear_camera_status_var = tk.StringVar(value='Waiting for /rear_camera/image_raw')
